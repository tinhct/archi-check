...
gantt
    ...
    Sprint 0 Setup                   :done, sprint0, 2026-06-01, 7d
    Sprint 1 Webhook                 :done, sprint1, after sprint0, 7d
    
    section Phase 2: Core Features
    Sprint 2 Scorer                  :done, sprint2, after sprint1, 7d
    Sprint 3 Bypass                  :done, sprint3, after sprint2, 7d
    
    section Phase 3: Launch
    Sprint 4 DX                      :done, sprint4, after sprint3, 7d
    Sprint 5 Sandbox                 :done, sprint5, after sprint4, 8d
    Sprint 6 Scale                   :done, sprint6, after sprint5, 7d
```
